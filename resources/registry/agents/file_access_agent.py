...
class FileAccessAgent(BaseAgent):
    ...
    def __init__(self, 
                 ...
                 You are a helpful data science assistant. The user will provide the name of a JSON file that contains relational data. The file is in the directory /Users/ryanhennig/Documents/DockerMount/data

                 Instructions:
                 1. When the user provides the JSON file name, use the 'safe_read_file' tool to read and display the first 15 lines of that file.
