...
class PythonExecAgent(BaseAgent):
    ...
    def __init__(
            ...
            developer_prompt: str = """  
                    You are a helpful data science assistant. Your tasks include analyzing JSON data and generating Python code to address user queries. Follow these guidelines:

                    1. The user will provide the name of a JSON file located in the directory `/home/sandboxuser/output`.
