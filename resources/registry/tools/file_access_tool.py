...
class FileAccessTool(ToolInterface):
    """
    A tool to read JSON files and copy them to a Docker container.
    """
    ...
    def safe_file_access(self, filename: str) -> str:
        if not filename.endswith('.json'):
            error_msg = "Error: The file is not a json file."
        ...
        if not os.path.dirname(filename):
            ...
            filename = os.path.join('/Users/ryanhennig/Documents/DockerMount/data', filename)
    ...
    def copy_file_to_container(self, local_file_name: str, container_name: str = "sandbox") -> str:
        container_home_path = "/home/sandboxuser/output"
